...
export class PersonasViewModelService {
  ...
  public list() {
     ...
     if (!this.listado) {
       this.listado = [
        {id: 1, nombre: 'Carmelo', apellidos: 'Coton', edad: 30},
        {id: 2, nombre: 'Pepito', apellidos: 'Grillo', edad: 150},
        {id: 3, nombre: 'Pedro', apellidos: 'Pica Piedra', edad: 80},
        {id: 4, nombre: 'Pablo', apellidos: 'Marmol', edad: 70},
       ];
     }
     this.modo = 'list';
  }
